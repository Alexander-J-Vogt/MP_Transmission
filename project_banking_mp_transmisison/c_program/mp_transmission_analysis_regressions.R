...
did_base_fe <- felm(log(total_amount_loan) ~ d_median_all + d_ffr_indicator + d_median_all * d_ffr_indicator | state | 0 | 0, data = main)
...
stargazer(did_base, did_base_fe, did_base_fe_ctrl1, did_base_fe_ctrl2, did_base_fe_ctrl4, did_base_fe_ctrl5,
          type = "text",
