...
DFBASE <- "mp_transmission_databasics"
DFMERGE <- "mp_transmission_varcreation_merge"
DFMAIN <- "mp_transmission_samplecreation_main"
...
PROJECTNAME <- 'project_mp_transmission'
